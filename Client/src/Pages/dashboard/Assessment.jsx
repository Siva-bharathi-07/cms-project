      ...
      <h1 className="text-4xl font-extrabold text-white drop-shadow-lg mb-12 tracking-wide flex items-center gap-3">
        ...
        >
          <path
            ...
            d="M12 20l9-5-9-5-9 5 9 5zm0 0v-5m0-5V4m0 0L3 9m9-5l9 5"
          />
        </svg>
        ASSESSMENT
      </h1>
            ...
            startTest ? (
              <div className="flex flex-col items-center space-y-5">
                <span className="text-2xl font-bold text-blue-800 flex items-center gap-2">
                  ...
                  <span className="underline">{selectedTopic}</span>
                </span>
                <button
              ...
              <span className="text-center text-2xl font-bold text-blue-800 mb-8 tracking-wider flex items-center gap-2">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M16 7a4 4 0 01-8 0m8 0a4 4 0 00-8 0m8 0V5a4 4 0 00-8 0v2m8 0a4 4 0 01-8 0"
                  />
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
